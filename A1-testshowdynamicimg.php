...
<nav class="navbar" id="nav">
        <ul class="list">
            ...
            <li>
              ...
              <a href="A1-insertcart.php " class="link login"> Cart(<?php echo $count ?>) </a>
   ...
   echo ' 
    ...
    <div class="gallery" style="display:flex; ">
        ...
        <div class="gdiv">
         ...
         <form action="A1-insertcart.php" method="post">
 
             <img src='.$img.' height="300px" width="270px"> <br>
             ...
             <div class="fff">
                 ...
                 <input type="hidden" name="PName" placeholder="Price" value='.$name.'">
                 <input type="hidden" name="PPrice" placeholder="Price" value='.$price.'">
               
                 <input type="text"   name="PQuantity" value="1" placeholder="Quantity" style="width:120px;">

                 <input type="hidden" name="PImage" placeholder="Price" value='.$img.'">
                 
              
               
                 
                 
                 <a href="coustmerinfo.html"><button class="buy" name="addcart">Buy Now!</button></a></pre>
